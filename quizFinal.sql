...
--
-- Host: localhost:3306
-- Generation Time: Apr 27, 2021 at 03:57 AM
...
--
CREATE DATABASE IF NOT EXISTS `siddhesh_quiz questions and choices` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `siddhesh_quiz questions and choices`;
